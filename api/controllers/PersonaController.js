...
if(req.param('rol')=='alumno'){
nuevaPersona.identificacion=req.param('identificacion')
}else{
nuevaPersona.identificacion =req.param('cedula')
    ...
    Persona.create(nuevaPersona).fetch().exec(function (err, datoPersona) {
      ...
      switch (rol) {
		...
		codigo_qr: datoPersona.paterno + " " + datoPersona.materno,
              rol: rol,
              idPersona: datoPersona.id
            }
  ...
  notificar_tutor: (req, res) => {
    ...
    var myClient = new OneSignal.Client({
      //userAuthKey: 'MGI1ODliM2QtYmU2NC00ZjgzLWIwM2EtOWYxNjI0NmI3MTVj',
	userAuthKey:'ODExYTNmNjEtMmZkZi00NTRmLWE4ODAtODZmZWIwNDAxODgw',      
// note that "app" must have "appAuthKey" and "appId" keys    
      app: {
     //   appAuthKey: 'ZmEzNzdmNjktMzQ0Ny00Y2IxLTk2YTMtNWU3MGYwNWFjNzUz',

	appAuthKey:'OGUxNDEzYzUtZTlkYy00ZjEzLTllOTMtNWQzNDBlYzM5MWFm',
//        appId: 'e338a31b-4667-471e-9a1a-4aa0c3cf6d5f'
